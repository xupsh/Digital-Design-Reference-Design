...
#dac clock
set_property PACKAGE_PIN A14 [get_ports clk_da]
set_property IOSTANDARD LVCMOS33 [get_ports clk_da]  
...
set_property PACKAGE_PIN W4 [get_ports {an[3]}]					
	...
	#waveform data
set_property PACKAGE_PIN R18 [get_ports {data_gen[7]}]							
set_property IOSTANDARD LVCMOS33 [get_ports {data_gen[7]}]
set_property PACKAGE_PIN P17 [get_ports {data_gen[6]}]							
set_property IOSTANDARD LVCMOS33 [get_ports {data_gen[6]}]
set_property PACKAGE_PIN M19 [get_ports {data_gen[5]}]							
set_property IOSTANDARD LVCMOS33 [get_ports {data_gen[5]}]
set_property PACKAGE_PIN L17 [get_ports {data_gen[4]}]							
set_property IOSTANDARD LVCMOS33 [get_ports {data_gen[4]}]
set_property PACKAGE_PIN P18 [get_ports {data_gen[3]}]							
set_property IOSTANDARD LVCMOS33 [get_ports {data_gen[3]}]
set_property PACKAGE_PIN N17 [get_ports {data_gen[2]}]							
set_property IOSTANDARD LVCMOS33 [get_ports {data_gen[2]}]
set_property PACKAGE_PIN M18 [get_ports {data_gen[1]}]							
set_property IOSTANDARD LVCMOS33 [get_ports {data_gen[1]}]
set_property PACKAGE_PIN K17 [get_ports {data_gen[0]}]							
