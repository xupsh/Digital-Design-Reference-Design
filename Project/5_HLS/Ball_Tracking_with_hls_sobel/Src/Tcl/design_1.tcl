...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.CLKOUT1_JITTER {151.636} CONFIG.CLKOUT1_PHASE_ERROR {98.575} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {50} CONFIG.CLKOUT2_JITTER {175.402} CONFIG.CLKOUT2_PHASE_ERROR {98.575} CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {25} CONFIG.CLKOUT2_USED {true} CONFIG.NUM_OUT_CLKS {2} CONFIG.USE_LOCKED {false} CONFIG.USE_RESET {false}  ] $clk_wiz_0
  ...
  set_property -dict [ list CONFIG.width {24}  ] $two2one_mux_0

  # Create instance: vga_0, and set properties
  set vga_0 [ create_bd_cell -type ip -vlnv xilinx.com:XUP:vga:1.0 vga_0 ]
  set_property -dict [ list CONFIG.HA {16} CONFIG.HB {96} CONFIG.HD {640} CONFIG.HF {48} CONFIG.HT {800} CONFIG.VA {10} CONFIG.VB {2} CONFIG.VD {480} CONFIG.VF {33} CONFIG.VT {525}  ] $vga_0
  ...
  set_property -dict [ list CONFIG.CONST_VAL {480} CONFIG.CONST_WIDTH {32}  ] $xlconstant_680
  ...
  set_property -dict [ list CONFIG.CONST_VAL {640} CONFIG.CONST_WIDTH {32}  ] $xlconstant_800
