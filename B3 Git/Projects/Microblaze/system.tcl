...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.POLARITY {ACTIVE_HIGH}  ] $reset_rtl_0
  ...
  set_property -dict [ list CONFIG.JITTER_SEL {No_Jitter} CONFIG.PRIMITIVE {MMCM} CONFIG.PRIM_SOURCE {Single_ended_clock_capable_pin}  ] $clk_wiz_1
