...
HD_PWD='e:/Github/xupsh/Basys3-Git/Projects_2016.2/2_Control_and_Measurement/Oscilloscope/Src/prj/Oscilloscope.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OSC_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source OSC_top.tcl -notrace
