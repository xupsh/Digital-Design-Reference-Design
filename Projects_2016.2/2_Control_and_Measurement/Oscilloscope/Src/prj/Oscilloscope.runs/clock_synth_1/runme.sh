...
HD_PWD='e:/Github/xupsh/Basys3-Git/Projects_2016.2/2_Control_and_Measurement/Oscilloscope/Src/prj/Oscilloscope.runs/clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock.vds -m64 -mode batch -messageDb vivado.pb -notrace -source clock.tcl
