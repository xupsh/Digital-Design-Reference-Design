...
HD_PWD='e:/Github/xupsh/Basys3-Git/Projects_2016.2/2_Control_and_Measurement/Oscilloscope/Src/prj/Oscilloscope.runs/vga_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source vga_0.tcl
