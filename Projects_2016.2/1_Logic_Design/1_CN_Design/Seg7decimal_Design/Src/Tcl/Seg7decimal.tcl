...
################################################################
# This is a generated script based on design: Seg7decimal
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins seg7decimal_0/clk]
  ...
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins seg7decimal_0/x]
