...
XADC #(// Initializing the XADC Control Registers
    ...
    .INIT_49(16'hc0c0),// CHSEL2 - enable aux analog channels 0 - 3
...
XADC_INST (// Connect up instance IO. See UG480 for port descriptions
    ...
    assign vauxp_active = {1'b0,VAUXP[3],6'b000000, 1'b0,VAUXP[2],6'b000000};
    assign vauxn_active = { 1'b0,VAUXN[3],6'b000000, 1'b0, VAUXN[2],6'b000000};
