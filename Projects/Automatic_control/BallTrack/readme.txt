...
Attention:
When you run the Basys3_BallTrack.tcl, vivado's run operation may be obstrucked in runing "place_design" progress. Then you can stop the running progress, open the vivado project setting options, and set "Place Design -directive" to "quick". Then re-run synthesis, implementation, and generate bitstream.
