...
step4:open the .jpg file£¬make the camera's lens focus on the  mathematical operation characters,make sure that all the characters is within the yellow rectangle,and the character's height
