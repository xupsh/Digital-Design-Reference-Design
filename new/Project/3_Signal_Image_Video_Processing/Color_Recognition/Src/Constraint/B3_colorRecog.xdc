...
set_property PACKAGE_PIN U18 [get_ports btn_extract]
set_property IOSTANDARD LVCMOS33 [get_ports btn_extract]

# Switch
set_property PACKAGE_PIN V17 [get_ports sw_clear]
set_property IOSTANDARD LVCMOS33 [get_ports sw_clear]
