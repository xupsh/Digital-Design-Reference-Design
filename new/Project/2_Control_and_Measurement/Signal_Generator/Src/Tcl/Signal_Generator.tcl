...
import_files [glob $prj_source/div_gen_0/*.xci]
import_files [glob $prj_source/seg7decimal_0/*.xci]
import_files -fileset constrs_1 [glob $prj_constraint/*.xdc]

set_property top waveform_gen [current_fileset]
